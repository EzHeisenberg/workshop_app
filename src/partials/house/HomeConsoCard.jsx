...
function HomeConsoCard() {
  ...
  const data = [
    4590, 4587, 4580, 4580, 4567, 4560, 4557, 4527, 4489, 4527,
    4470, 4320, 4290, 4100, 4021, 3730, 3630, 3410, 3240, 3230, 3270, 3290, 3250, 3260, 3230,
  ];

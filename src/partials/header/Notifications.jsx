  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      <Transition
        ...
        leaveEnd="opacity-0"
      >
        <div style={{width: window.innerWidth / 1.4}}
          ref={dropdown}
          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Mike a éteint tout le <u>Salon</u>.</span></span>
                <span className="block text-xs font-medium text-slate-400">Feb 12, 2023</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Chauffage programmé pour 6h40 dans la <u>salle de bain</u>.</span></span>
                <span className="block text-xs font-medium text-slate-400">Feb 9, 2023</span>
              </Link>
            </li>
          </ul>
        </div>
